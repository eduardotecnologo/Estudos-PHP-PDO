...
$app->get(
    '/produtos', function (){
        ...
        $data = $sql->select("SELECT * FROM `star-fake`.tb_produtos where preco_promorcional > 0 order by preco_promorcional desc limit 4;");
...
$app->get(
    '/produtos-mais-buscados', function(){
...
$app->get(
    '/produto-:id_prod', function($id_prod){

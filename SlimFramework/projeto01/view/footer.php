							...
							<div class="row row-cols">
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<address class="hidden-xs">
										<i class="fa fa-map-marker"></i> <span>Juiz de Fora - Minas gerais<br/>Brazil</span>
									</address>

									<p class="hidden-xs"><a href="tel:1855ORLCITY"><i class="fa fa-phone"></i>+55 (99)9999-9999</a></p>
									...
									<div class="row-fluid visible-xs">
										...
										<div class="col-xs-6">
											<a href="#" class="btn btn-footer"><i class="fa fa-phone"></i>Tel:</a>
										</div>
									</div>

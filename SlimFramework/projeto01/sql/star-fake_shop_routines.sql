CREATE DATABASE  IF NOT EXISTS `star-fake` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `star-fake`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: star-fake
-- ------------------------------------------------------
...
--
-- Dumping events for database 'star-fake'
--

--
-- Dumping routines for database 'star-fake'
--
